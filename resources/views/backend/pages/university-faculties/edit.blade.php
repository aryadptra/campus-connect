                ...
                <div class="card card-Vertical card-default card-md mb-4 mt-30">
                    ...
                    <div class="card-body pb-md-30">
                        ...
                        <div class="Vertical-form">
                            <form action="{{ route('university-faculties.update', $faculty->id) }}" method="POST"
                                    ...
                                    <div class="col-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="text" hidden name="university_id"
                                                value="{{ $faculty->university->id }}" placeholder="1">
                                            <input type="text"
                                                class="form-control ih-medium ip-gray radius-xs b-light px-15"
                                                id="text" readonly value="{{ $faculty->university->name }}"
                                                placeholder="1">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                class="form-control ih-medium ip-gray radius-xs b-light px-15"
                                                id="name" value="{{ $faculty->name }}" name="name" required

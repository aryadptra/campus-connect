                ...
                <div class="card card-Vertical card-default card-md mb-4 mt-30">
                    ...
                    <div class="card-body pb-md-30">
                        ...
                        <div class="Vertical-form">
                            <form action="{{ route('university-blog.store') }}" method="POST"
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="name" value="{{ old('title') }}" name="title" required
                                                placeholder="Cara Membuat Blog">

                                            <input type="text"
                                                class="form-control ih-medium ip-gray radius-xs b-light px-15" hidden
                                                value="{{ $university['id'] }}" name="university_id" required
                                                placeholder="Cara Membuat Blog">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="isi" required id="exampleFormControlTextarea1" rows="3"
                                                placeholder="Blog Adalah Sebuah Artikel Yang ....">{{ old('isi') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-file">
                                                <input class="form-control custom-file-input" name="image" required

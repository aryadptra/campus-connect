                ...
                <div class="card card-Vertical card-default card-md mb-4 mt-30">
                    ...
                    <div class="card-body pb-md-30">
                        ...
                        <div class="Vertical-form">
                            <form action="{{ route('university-study-program.update', $studyProgram->id) }}" method="POST"
                                    ...
                                    <div class="col-12 col-md-12">
                                        <div class="form-group">
                                            <label for="formGroupExampleInput3"
                                                class="color-dark fs-14 fw-500 align-center mb-10">Fakultas</label>
                                            <input type="text"
                                                class="form-control ih-medium ip-gray radius-xs b-light px-15"
                                                id="text" hidden name="faculty_id"
                                                value="{{ $studyProgram->faculty->id }}" placeholder="1">
                                            <input type="text"
                                                class="form-control ih-medium ip-gray radius-xs b-light px-15"
                                                id="text" readonly value="{{ $studyProgram->faculty->name }}"
                                                placeholder="1">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                class="form-control ih-medium ip-gray radius-xs b-light px-15"
                                                id="name" value="{{ $studyProgram->name }}" name="name" required
